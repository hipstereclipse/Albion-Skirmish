...
Generated screenshots for the current Albion Skirmish build.

- `start-menu.png`: launch screen and game options.
- `in-game.png`: live match view with HUD, minimap, terrain, units, walls/towers, and the research/train button list.
